...
class Seq2SeqModel():
    ...
    def get_dummy_array(self, dummy_num, dummy_dim ):
        return np.array([dummy_num] * dummy_dim)

    def get_batch(self, X, vocab_size, batch_size, input_dim, output_dim):
        global PAD, EOS
        ...
        for a in range(batch_size):
            ...
            encoder_pad = [self.get_dummy_array(PAD,input_dim)] * (encoder_size - len(encoder_inputs))
