...
--output_graph=/tmp/graph_def.pb --output_node_names=softmax
...
import argparse
import sys
from tensorflow.python.tools import freeze_graph_test
...
def freeze_graph(input_graph,
  ...
  with session.Session() as sess:
    ...
    variable_names = [node.name for node in output_graph_def.node]
